...
export interface NewsfeedContextType {
    ...
    loading: boolean;
    error: string | null;
    uploadImage: (file: File) => Promise<{ image_id: string; file_url: string }>;
    createPost: (title: string, content: string, category: string, imageId?: string) => Promise<void>;
    updatePost: (id: number, title?: string, content?: string, category?: string, imageId?: string | null) => Promise<void>;
    deletePost: (id: number) => Promise<void>;
    loadMorePosts: () => void;
    hasNextPage: boolean;
}

export const NewsfeedContext = createContext<NewsfeedContextType | undefined>(undefined);
