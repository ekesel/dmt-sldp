...
export const KnowledgeHeader: React.FC<KnowledgeHeaderProps> = ({
  ...
  return (
    <header className="flex items-center justify-between px-4 xl:px-8 py-4 bg-white/40 backdrop-blur-sm border-b border-border/40">
      ...
      <div className="flex items-center gap-2 lg:gap-4">
        <div className="relative group hidden md:block">
          ...
          <input
            ...
            className="pl-10 pr-4 py-2 bg-white/60 border border-border/40 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/40 transition-all w-48 lg:w-64 shadow-sm"
          />
        </div>
