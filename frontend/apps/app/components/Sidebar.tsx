            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive
                  ...
                  : "text-foreground font-semibold hover:bg-accent/70 hover:text-foreground"
                  }`}
              >
                ...
                {item.section && (
                  <span
                    className={`ml-auto text-[10px] px-1.5 py-0.5 rounded uppercase tracking-wider font-semibold ${isActive
