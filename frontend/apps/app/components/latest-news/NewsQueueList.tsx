  ...
  return (
    <div className="p-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="flex items-center gap-2 px-4 py-2 bg-secondary/80 rounded-full text-secondary-foreground text-[0.8125rem] font-bold hover:bg-secondary transition-colors border border-border">
      ...
      <div className="space-y-4">
        {items.map((item, index) => (
          <div
            key={item.id}
            className="flex items-center justify-between border border-border rounded-[1.25rem] p-4 hover:shadow-sm hover:border-border/80 transition-all group bg-card"
          >
            <div className="flex items-start sm:items-center gap-4 sm:gap-5 w-full">
              ...
              <div className="pr-4 sm:pr-0">
                <h4 className="text-[0.9375rem] font-bold text-foreground mb-1 group-hover:text-primary transition-colors line-clamp-1">
                  {item.content}
                </h4>
                <p className="text-[0.8125rem] text-muted-foreground font-medium flex items-center gap-1.5">
            ...
            <span className={`text-[0.75rem] px-4 py-1.5 rounded-full font-bold whitespace-nowrap transition-colors shrink-0 ${
               index === 0 
