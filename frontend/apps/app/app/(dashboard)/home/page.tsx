...
export default function HomePage() {
  return (
    <div className="h-full flex flex-col bg-[#F3F4F6] px-4 pt-2 pb-3 lg:px-6 lg:pt-3 lg:pb-4">
      {/* Inner container: flex column, fills all available height */}
      <div className="max-w-[100rem] w-full mx-auto flex flex-col gap-4 flex-1 min-h-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 flex-1 min-h-0">
          ...
          {/* Quick Access Tiles */}
          <div className="lg:col-span-6 xl:col-span-4 flex flex-col min-h-0">
            <QuickAccessTiles />
          </div>
          ...
          {/* Celebrations Card */}
          <div className="lg:col-span-12 xl:col-span-4 flex flex-col min-h-0">
            <CelebrationsCard />
          </div>
        </div>
