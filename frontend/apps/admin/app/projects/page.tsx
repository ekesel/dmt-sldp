                    ...
                    <div className="flex gap-4">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="bg-muted/50 border border-border rounded-lg pl-10 pr-4 py-2 text-foreground focus:outline-none focus:ring-2 focus:ring-primary/40 transition"
                            />
                        </div>
