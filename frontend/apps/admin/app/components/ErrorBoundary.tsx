            ...
            return (
                <div className="min-h-screen flex items-center justify-center bg-background text-foreground p-4">
                    <div className="max-w-md w-full bg-card border border-border rounded-xl p-8 shadow-2xl text-center">
                        ...
                        {this.state.error && (
                            <div className="mb-6 p-4 bg-muted/50 rounded-lg text-left overflow-auto max-h-40 border border-border">
                        ...
                        <button
                            ...
                            className="px-6 py-2 bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg transition-colors font-medium w-full shadow-lg shadow-primary/20"
                        >
                            Reload Application
                        </button>
                    </div>
