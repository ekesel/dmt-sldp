...
import { Users, Plus, Shield, MoreVertical, Search, Filter, ChevronLeft, ChevronRight, Edit2, Trash2, X } from 'lucide-react';
        ...
        <DashboardLayout>
            <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        <h1 className="text-3xl font-bold text-white mb-2 font-['Outfit']">Users</h1>
